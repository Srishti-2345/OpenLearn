        ...
        <ul className="flex items-center justify-between h-16 bg-[var(--color-cyberDark)] text-[var(--color-neonBlue)] px-6">
          ...
          <li className="list-none">
            <ul className="flex items-center gap-8">
              ...
              <li className="cursor-pointer" onClick={onContributeClick}>
                Contribute
                {!isPremium && <span className="ml-1 text-xs text-amber-300">(Premium)</span>}
              </li>
            </ul>
          </li>
          <li className="flex items-center gap-3">
            <button
              className={`rounded-lg px-4 py-2 text-sm font-semibold ${isPremium
                  ? "border border-emerald-400/40 bg-emerald-500/10 text-emerald-300 hover:bg-emerald-500/20"
                  : "border border-amber-400/50 bg-amber-500/10 text-amber-300 hover:bg-amber-500/20"
                }`}
